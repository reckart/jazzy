...
public class JTextComponentSpellCheckExample extends JFrame {
  ...
  public JTextComponentSpellCheckExample () {
    ...
    try {
      dictionary = new SpellDictionaryHashMap(new File("dict/"+dictionaryFile),
  ...
  private void addToFrame (Container f, Component c, GridBagLayout gbl, GridBagConstraints gbc,
